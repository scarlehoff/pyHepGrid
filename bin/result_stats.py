...
class RuncardStats():
    ...
    def __init__(self, fullpath, directory, parseargs):
        ...
        self.runcard = self.directory.replace(
...
def parser_setup():
    ...
    parser.add_argument('--rev', help='reverse sort.',
                        action='store_false', default=True)
    parser.add_argument('--runcard', '-rc',
                        help='sort by runcard name.', action='store_true')
    parser.add_argument(
        '--tag', '-t', help='display runcard tags.', action='store_true')
    parser.add_argument('--nofiles', '-n',
                        help='sort by no files.', action='store_true')
