...
# logger.debug     debug statement                               10
...
# :) It also allows us to keep a lot of debug statements in the code that are
# ignored at runtime when by default we only print messages with levels of
# VALUES or higher. This can be changed with the command line argument
# debuglevel = [debug/value/...] which will then print only statements of that
